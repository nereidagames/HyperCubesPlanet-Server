...
app.options('*', cors()); // Ważne dla preflight requests
...
const pool = new Pool({
  ...
  ssl: { rejectUnauthorized: false } // Wymagane dla Neon/Render
});
...
async function loadNexusMapToMemory() {
    try {
        // Sprawdź czy tabela istnieje zanim zapytasz
